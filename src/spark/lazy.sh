...
./spark-3.5.0-bin-hadoop3/bin/spark-submit \
    ...
    s3a://mybucket/graphalytics-platforms-graphx-0.2-SNAPSHOT.jar \
    s3a://mybucket/path/to/test-bfs-directed-BFS \
    s3a://mybucket/test-bfs-directed.e \
    s3a://mybucket/test-bfs-directed.v\
    true \
    s3a://mybucket/output.txt \
    --parameters '{"sourceVertex": 1}'
